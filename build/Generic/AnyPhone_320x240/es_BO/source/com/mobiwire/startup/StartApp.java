...
//            formFactura.append( table );
 ...
 table.setSelectionMode( TableItem.SELECTION_MODE_CELL );
                ...
                table.addColumn();
               //#style heading
                table.set(0, 0,"Producto", de.enough.polish.ui.StyleSheet.headingStyle );
                //#style heading
                table.set(1, 0,"Costo", de.enough.polish.ui.StyleSheet.headingStyle );
//                table.set(2, 0,"Bs");
                 double total=0;
                 double bonidesc=0;
...
//                  table.addRow();
                    Products pro = (Products) listaProductos.elementAt(i);
                    //#style bodys
                   table.set(1, i+1,""+Integer.parseInt(pro.getCost()), de.enough.polish.ui.StyleSheet.bodysStyle );     
                   //#style bodys
                   table.set(0, i+1, pro.getNotes(), de.enough.polish.ui.StyleSheet.bodysStyle );
                    //pruebas 
...
//                    table.setSelectionMode( TableItem.SELECTION_MODE_ROW  );
                 //#style bodys
                   table.set(0, i+1, invitem.getNotes(), de.enough.polish.ui.StyleSheet.bodysStyle );     
//                   table.setSelectionMode( TableItem.SELECTION_MODE_ROW  );
                 //#style bodys
                   table.set(1, i+1, ""+cost, de.enough.polish.ui.StyleSheet.bodysStyle );
...
//           imprimir.printText(ConstruirFila(""+(int)c,concepto,redondeo(costo,2)+""+redondeo(subTotal,2)), 1);  
    ...
    {
        //#style mailAlert
       Alert alert = new Alert(titulo, mensaje, null, AlertType.CONFIRMATION, de.enough.polish.ui.StyleSheet.mailalertStyle );
       final Command cmdYes = new Command("Aceptar", Command.OK, 1);
...
//        {
            //#style mailAlert
             Alert alert= new Alert(t, m+" status:"+print.getPaperStatus(), null, AlertType.CONFIRMATION, de.enough.polish.ui.StyleSheet.mailalertStyle );
            final Command cmdYes = new Command("Aceptar", Command.OK, 1);
