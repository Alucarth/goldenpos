...
public class MenuBar extends Item {
	...
	public MenuBar(Screen screen, Style style) {
		...
		this.singleRightCommandItem = new CommandItem( dummy, this , de.enough.polish.ui.StyleSheet.rightcommandStyle );
		this.singleRightCommandItem.setImageAlign( Graphics.LEFT );
		//#style leftcommand, command, default
		this.singleLeftCommandItem = new CommandItem( dummy, this , de.enough.polish.ui.StyleSheet.leftcommandStyle );
