...
//$$IncludeLocaleDefinitionHere$$//
	public static final String CURRENCY_CODE = "BOB";
	public static final String CURRENCY_SYMBOL = "B$";
	public static final String DISPLAY_COUNTRY = "Bolivia";
	public static final String COUNTRY = "BO";
