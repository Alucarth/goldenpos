...
//#endif
{
	...
	//#ifdef polish.i18n.useDynamicTranslations
			//# /**
			 ...
			 //# */
			//# public static Command CLEAR_CMD = new Command( "Limpiar", CLEAR_TYPE, CLEAR_PRIORITY );
	//#elifdef polish.command.clear:defined
public static final Command CLEAR_CMD = new Command( "Limpiar", CLEAR_TYPE, CLEAR_PRIORITY );
	//#else
...
private final static int DELETE_PRIORITY = 0;
		//#else
		...
		private final static int DELETE_TYPE = 
				...
				//#endif
		//#ifdef polish.i18n.useDynamicTranslations
			//# public static Command DELETE_CMD = new Command( "Borrar", DELETE_TYPE, DELETE_PRIORITY );
		//#elifdef polish.command.delete:defined
public static final Command DELETE_CMD = new Command( "Borrar", DELETE_TYPE, DELETE_PRIORITY );
		//#else
...
protected static String charactersKeyPound = "#@:()\u0026\u00BF?$!/_";
		//#else
		...
		//#if tmp.includeInputInfo
			if (this.infoItem == null) {
				//#if !polish.TextField.useExternalInfo
					//#style info, default
					this.infoItem = new StringItem( null, modeStr , de.enough.polish.ui.StyleSheet.infoStyle );
