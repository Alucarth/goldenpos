...
public class List extends Screen implements Choice
{
	...
	//#ifdef polish.i18n.useDynamicTranslations
		//# public static Command SELECT_COMMAND = new Command( "Seleccionar", Command.ITEM, 3 );
	//#elifdef polish.command.select:defined
public static final Command SELECT_COMMAND = new Command("Seleccionar", Command.ITEM, 3 );
	//#else
