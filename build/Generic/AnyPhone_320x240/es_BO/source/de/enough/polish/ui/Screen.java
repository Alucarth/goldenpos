...
implements UiElement, Animatable
{
	...
	//#if polish.useScrollBar || polish.classes.ScrollBar:defined
		...
		//#else
			//#style scrollbar?
			protected final ScrollBar scrollBar = new ScrollBar(de.enough.polish.ui.StyleSheet.scrollbarStyle );
		//#endif
...
this.previousScreenOverlayBackground = new TranslucentSimpleBackground( 0x96000000 );
							//#else
	...
	public void setTitle(Item item, Style tStyle) {
		//#ifdef tmp.usingTitle
			...
			//#endif
			{
				...
				if (item != null){
					//#ifdef polish.ScreenWidth:defined
int width = 320  - (this.marginLeft + this.marginRight);
					//#else
						//# int width = this.screenWidth - (this.marginLeft + this.marginRight);
					//#endif
					if (width > 1) {
